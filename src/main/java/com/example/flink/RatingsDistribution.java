...
public class RatingsDistribution {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataSource<String> file = env.readTextFile("/Users/ivanmushketyk/SparkCourse/ml-100k/u.data");
        file.map(new ExtractRating())
            .groupBy(0)
    ...
    private static class ExtractRating implements MapFunction<String, Tuple2<IntValue, Integer>> {
        ...
        @Override
        public Tuple2<IntValue, Integer> map(String s) throws Exception {
